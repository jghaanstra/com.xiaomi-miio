...
module.exports = {
  ...
  'zhimi.airpurifier.mc2': AirPurifier, // generic driver
	'airdog.airpurifier.x3': AirPurifier, // untested
	'airdog.airpurifier.x5': AirPurifier, // untested
	'airdog.airpurifier.x7sm': AirPurifier, // untested
	'zhimi.airpurifier.mb3': AirPurifier3, // own driver
	'zhimi.airpurifier.mb4': AirPurifier3c, // own driver

	/* Humidifiers */
	'zhimi.humidifier.v1': Humidifier, // own driver
	'zhimi.humidifier.ca1': Humidifier2, // own driver
  'zhimi.humidifier.cb1': Humidifier2, // own driver
	'zhimi.humidifier.ca4': Humidifier2, // own driver
	'deerma.humidifier.jsq': Humidifier2, // own driver
	'deerma.humidifier.jsq1': Humidifier2, // own driver
	'deerma.humidifier.jsq4': Humidifier2, // own driver
	'deerma.humidifier.jsq4': Humidifier2, // own driver
	'deerma.humidifier.mjjsq': Humidifier2, // own driver
	'leshow.humidifier.jsq1': Humidifier2, // own driver
	'shuii.humidifier.jsq001': Humidifier2, // generic driver
  ...
  'zhimi.fan.za1': ZhiMiFan, // generic
	...
	/* Vacuums */
	"rockrobo.vacuum.v1": Vacuum, // own driver
	"rockrobo.vacuum.1s": Vacuum, // own driver
  "roborock.vacuum.s5": Vacuum, // own driver
  "roborock.vacuum.s5e": Vacuum,
  "roborock.vacuum.c1": Vacuum,
  "roborock.vacuum.s6": Vacuum,
  "roborock.vacuum.t6": Vacuum, // own driver
