...
module.exports = {
	...
	/* Air Purifiers */
  'zhimi.airpurifier.v1': AirPurifier, // generic driver
	'zhimi.airpurifier.v2': AirPurifier, // generic driver
	'zhimi.airpurifier.v3': AirPurifier, // generic driver
  'zhimi.airpurifier.v4': AirPurifier, // generic driver
  'zhimi.airpurifier.v5': AirPurifier, // generic driver
	'zhimi.airpurifier.v6': AirPurifier, // own driver
  'zhimi.airpurifier.v7': AirPurifier, // own driver
	'zhimi.airpurifier.m1': AirPurifier, // generic driver
	'zhimi.airpurifier.m2': AirPurifier, // generic driver
	'zhimi.airpurifier.ma2': AirPurifier, // own driver
	'zhimi.airpurifier.mc1': AirPurifier, // generic driver
  'zhimi.airpurifier.mc2': AirPurifier, // generic driver
	...
	'zhimi.airpurifier.mb3': AirPurifier3, // own driver
	'zhimi.airpurifier.mb4': AirPurifier3c, // own driver

	/* Humidifiers */
	'zhimi.humidifier.v1': Humidifier, // generic + own driver
	'zhimi.humidifier.ca1': Humidifier2, // generic + own driver
  'zhimi.humidifier.cb1': Humidifier2, // generic + own driver
	// 'zhimi.humidifier.ca4': Humidifier2, // own driver
	// 'deerma.humidifier.jsq': Humidifier2, // humidifier_deerma_humidifier_jsq
	// 'deerma.humidifier.jsq1': Humidifier2, // humidifier_deerma_humidifier_jsq
	// 'deerma.humidifier.jsq4': Humidifier2, // humidifier_deerma_humidifier_jsq4
	// 'deerma.humidifier.jsq5': Humidifier2, // humidifier_deerma_humidifier_jsq5
	// 'deerma.humidifier.mjjsq': Humidifier2, // humidifier_deerma_humidifier_jsq
	// 'leshow.humidifier.jsq1': Humidifier2, // humidifier_leshow_humidifier_jsq1
	'shuii.humidifier.jsq001': Humidifier2, // untested generic driver

	/* Fans */
	'dmaker.fan.p5': DmakerFan, // generic
	'dmaker.fan.p15': DmakerFan, // generic
  'zhimi.fan.v1': ZhiMiFan, // generic
  'zhimi.fan.v2': ZhiMiFanv2v3, // generic
  'zhimi.fan.v3': ZhiMiFanv2v3, // generic
	'zhimi.fan.sa1': ZhiMiFan, // generic
  'zhimi.fan.za1': ZhiMiFan, // generic
	'zhimi.fan.za3': ZhiMiFan, // generic
	// 'zhimi.fan.za4': ZhiMiFan, // own driver
	// 'zhimi.fan.za5': ZhiMiFan, // own driver
  ...
  "roborock.vacuum.a10": Vacuum,
	...
	"mijia.vacuum.v2":  MijiaVacuum,

	//"dreame.vacuum.mc1808": ViomiVacuum, // own driver
	//"dreame.vacuum.p2008": ViomiVacuum, // own driver
	//"dreame.vacuum.p2009": ViomiVacuum, // own driver
	//"dreame.vacuum.p2028": ViomiVacuum, // own driver
	//"dreame.vacuum.p2041o": ViomiVacuum, // own driver
	//"dreame.vacuum.p2150a": ViomiVacuum, // own driver
	//"dreame.vacuum.p2150o": ViomiVacuum, // own driver
	//"dreame.vacuum.p2029": ViomiVacuum, // own driver
	//"dreame.vacuum.p2041": ViomiVacuum, // own driver
